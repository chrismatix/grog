...
* [grog build-and-test](/reference/cli/grog_build-and-test/)	 - Loads the user configuration and executes build and test targets.
...
* [grog run](/reference/cli/grog_run/)	 - Builds and runs one or more targets' binary outputs.
