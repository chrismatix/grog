...
<Aside>
  For richer Grafana dashboards, consider sending traces to both Loki (for log-based queries) and
  Tempo (for waterfall visualization) from the same CI pipeline.
</Aside>
