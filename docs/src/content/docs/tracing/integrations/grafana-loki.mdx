---
title: Grafana Loki
description: Ship Grog execution traces to Grafana Loki for log-based build queries.
---

import { Aside } from "@astrojs/starlight/components";

JSONL [execution traces](/tracing/) can be shipped to Loki and queried with LogQL in Grafana dashboards.
