---
title: BigQuery
description: Load Grog execution traces into BigQuery for historical build analytics across large teams.
---

import { Aside } from "@astrojs/starlight/components";

BigQuery is a natural fit for historical build analytics across large teams. Load JSONL [execution traces](/tracing/) into a table and query across weeks or months of builds.
