...
Replace `otlp.datadoghq.com` with the OTLP endpoint for your [Datadog site](https://docs.datadoghq.com/getting_started/site/) (e.g. `otlp.datadoghq.eu`, `otlp.us5.datadoghq.com`).
