...
All examples will be based on the Python [example repository](https://github.com/chrismatix/grog/tree/main/examples/python_uv_monorepo) which contains a library that is shared by a server and a cli target.
