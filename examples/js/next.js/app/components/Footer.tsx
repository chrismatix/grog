  ...
  return (
    <footer className="flex gap-[24px] flex-wrap items-center justify-center">
      <Link
        ...
        icon={<Image aria-hidden src="/file.svg" alt="File icon" width={16} height={16} />}
      >
        Learn
      </Link>
      ...
      <Link
        ...
        icon={<Image aria-hidden src="/window.svg" alt="Window icon" width={16} height={16} />}
      >
        Examples
      </Link>
      ...
      <Link
        ...
        icon={<Image aria-hidden src="/globe.svg" alt="Globe icon" width={16} height={16} />}
      >
        Go to nextjs.org →
      </Link>
