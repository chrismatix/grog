...
type Handler interface {
	...
	Write(ctx context.Context, target model.Target, output model.Output, tracker *worker.ProgressTracker, update worker.StatusFunc) (*gen.Output, error)
	...
	Load(ctx context.Context, target model.Target, output *gen.Output, tracker *worker.ProgressTracker, update worker.StatusFunc) error
}
